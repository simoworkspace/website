...
export const FormAddbot: React.FC = () => {
    ...
    return (
        <div className="mb-[70px] p-3 w-[100vw] flex items-center justify-center">
            <div className={`bg-black border-2 shadow-lg transition-all duration-300  ${color === "blue" && "border-blue-500 shadow-blue-500"
                } ${color === "green" && "border-green-500 shadow-green-500"} ${color === "red" && "border-red-500 shadow-red-500"
                } rounded-lg p-2`}>
