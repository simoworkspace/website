                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {teams ? (
                                    <div className="flex flex-wrap gap-3">
                                        {teams.map(team => (
                                            <Link to={`/teams/${team.id}`} className="bg-neutral-800 p-3 rounded-lg duration-300 transition-colors hover:bg-neutral-700">
                                    ...
                                    <div className="bg-neutral-800 p-3 rounded-lg duration-300 h-32 w-64">
                                        <div className="flex flex-row gap-2 items-center justify-center">
