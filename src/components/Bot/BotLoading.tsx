            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <section className="w-[90%] mb-5 bg-neutral-900 border-2 border-t-0 rounded-t-none rounded-lg p-10 xl:p-3">
                    <div className="flex flex-row xl:flex-col">
                        <div className="w-[80%] xl:w-full flex break-words xl:justify-center">
                        ...
                        <div className="flex flex-col gap-5 text-white px-5 w-[45%] xl:w-full">
                            <div className="w-full">
                                <div className="w-full">
                                    ...
                                    <div>
                                        <a className="bg-neutral-800 p-2 rounded-lg flex flex-row xl:flex-col items-center gap-4 transition-colors duration-300 hover:bg-neutral-800 w-full h-[80px] animate-pulse"></a>
                                    </div>
                                </div>
                                <div>
