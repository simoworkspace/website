...
export const VoteLoading: React.FC = () => {
    return (
        <section className="text-white p-3 w-screen flex flex-col items-center justify-center]">
            ...
            <div className="animate-pulse flex xl:flex-col border-2 xl:w-full xl:justify-center xl:items-center xl:h-full w-full h-[80px] flex-row rounded-lg items-center bg-neutral-900  max-w-[1500px]"></div>
        </section>
    );
};