    ...
    return user && (
        (
            <section ref={menuRef} className={`${!user && "invisible"}`}>
                ...
                <div className={`${isOpen ? "opacity-100" : "opacity-0 invisible"} ${scrollBar[color]} p-3 xl:invisible overflow-auto flex-col flex text-white rounded-lg absolute right-[209px] max-h-[300px] w-[500px] top-[101px] origin-top-right bg-neutral-900 border-2 transition-all duration-300 ${borderColor[color]}`}>
                    {isLoading ? (
