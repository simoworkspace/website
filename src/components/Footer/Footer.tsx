...
export const Footer: React.FC = () => {
    return (
        <footer className="border-t-[1px] border-[#8b8b8b] w-[100%] h-[90px] xl:h-[120px] text-white flex items-center xl:mb-[70px]">
            <div className="text-white flex flex-row xp:flex-col items-center text-center justify-center text-[32px] mx-10 my-3 xl:mx-0">
                <strong>Simo</strong>
                <div className="bg-white w-[30px] h-[1px] mx-[20px] xp:invisible"></div>
